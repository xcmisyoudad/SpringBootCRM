...
public class CheckIn {
	...
	public CheckIn(Integer checkIn_Id, Integer checkIn_UserId, String checkIn_Time, String checkIn_EndTime,
			...
			String checkIn_Exit2, Users users) {
		super();
		this.checkIn_Id = checkIn_Id;
		this.checkIn_UserId = checkIn_UserId;
		this.checkIn_Time = checkIn_Time;
	...
	public String toString() {
		return "CheckIn [checkIn_Id=" + checkIn_Id + ", checkIn_UserId=" + checkIn_UserId + ", checkIn_Time="
				+ checkIn_Time + ", checkIn_EndTime=" + checkIn_EndTime + ", checkIn_Status=" + checkIn_Status
				+ ", checkIn_WorkingHours=" + checkIn_WorkingHours + ", checkIn_Late=" + checkIn_Late
				+ ", checkIn_Exit1=" + checkIn_Exit1 + ", checkIn_Exit2=" + checkIn_Exit2 + ", users=" + users + "]";
	}
